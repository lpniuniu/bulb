...
- (void)testResetFromSave
{
    [[Bulb bulbGlobal] save:[BulbTestRegisterSignal signal] data:nil];
    __block id testRegister_init_from_save = nil;
    BulbSlot* slot = [[Bulb bulbGlobal] registerSignal:[BulbTestRegisterSignal signalResetFromSave] block:^(id firstData, NSDictionary<NSString *,id> *signalIdentifier2data) {
    ...
    // forever
    slot = [[Bulb bulbGlobal] registerSignal:[BulbTestRegisterSignal signalResetFromSave] foreverblock:^BOOL(id firstData, NSDictionary<NSString *,id> *signalIdentifier2data) {
        testRegister_init_from_save = @"not null";
        return YES;
    }];
    XCTAssert(signal != nil);
    ...
    testRegister_init_from_save = nil;
    [[Bulb bulbGlobal] remove:[BulbTestRegisterSignal signalResetFromSave]];
    [[Bulb bulbGlobal] registerSignal:[BulbTestRegisterSignal signalResetFromSave] block:^(id firstData, NSDictionary<NSString *,id> *signalIdentifier2data) {
        testRegister_init_from_save = @"not null";
    }];
    XCTAssert(testRegister_init_from_save == nil);
    [[Bulb bulbGlobal] fire:[BulbTestRegisterSignal signal] data:nil];
    ...
    [[Bulb bulbGlobal] registerSignals:@[[BulbTestRegisterMutiStatusSignal signalResetFromSaveWithStatus:@"status"], [BulbTestRegisterMutiStatusSignal1 signalWithStatus:@"status1"]] block:^(id firstData, NSDictionary<NSString *,id> *signalIdentifier2data) {
        testRegister_init_from_save = @"not null";
    }];
    XCTAssert(testRegister_init_from_save == nil);
    [[Bulb bulbGlobal] fire:[BulbTestRegisterMutiStatusSignal1 signalResetFromSaveWithStatus:@"status1"] data:nil];
    XCTAssert(testRegister_init_from_save != nil);
    
    testRegister_init_from_save = nil;
    [[Bulb bulbGlobal] save:[BulbTestRegisterMutiStatusSignal1 signalWithStatus:@"status1"] data:nil];
    [[Bulb bulbGlobal] registerSignals:@[[BulbTestRegisterMutiStatusSignal signalResetFromSaveWithStatus:@"status"], [BulbTestRegisterMutiStatusSignal1 signalResetFromSaveWithStatus:@"status1"]] foreverblock:^(id firstData, NSDictionary<NSString *,id> *signalIdentifier2data) {
        testRegister_init_from_save = @"not null";
        return YES;
    }];
    XCTAssert(testRegister_init_from_save != nil);
    ...
    [[Bulb bulbGlobal] fire:[BulbTestRegisterMutiStatusSignal signalResetFromSaveWithStatus:@"status"] data:nil];
    XCTAssert(testRegister_init_from_save == nil);
}
