...
- (void)testRecoverFromSave
{
    ...
    BulbSlot* slot = [[Bulb bulbGlobal] registerSignal:[BulbTestRegisterSignal signalRecoverFromSave] block:^(id firstData, NSDictionary<NSString *,id> *signalIdentifier2data) {
    ...
    // forever
    slot = [[Bulb bulbGlobal] registerSignal:[BulbTestRegisterSignal signalRecoverFromSave] foreverblock:^BOOL(id firstData, NSDictionary<NSString *,id> *signalIdentifier2data) {
        testRegister_init_from_save = @"not null";
        return YES;
    }];
    XCTAssert(signal != nil);
    ...
    [[Bulb bulbGlobal] registerSignal:[BulbTestRegisterSignal signalRecoverFromSave] block:^(id firstData, NSDictionary<NSString *,id> *signalIdentifier2data) {
        testRegister_init_from_save = @"not null";
    }];
    XCTAssert(testRegister_init_from_save == nil);
    [[Bulb bulbGlobal] fire:[BulbTestRegisterSignal signal] data:nil];
    ...
    [[Bulb bulbGlobal] registerSignals:@[[BulbTestRegisterMutiStatusSignal signalRecoverFromSaveWithStatus:@"status"], [BulbTestRegisterMutiStatusSignal1 signalWithStatus:@"status1"]] block:^(id firstData, NSDictionary<NSString *,id> *signalIdentifier2data) {
        testRegister_init_from_save = @"not null";
    }];
    XCTAssert(testRegister_init_from_save == nil);
    ...
    [[Bulb bulbGlobal] registerSignals:@[[BulbTestRegisterMutiStatusSignal signalRecoverFromSaveWithStatus:@"status"], [BulbTestRegisterMutiStatusSignal1 signalRecoverFromSaveWithStatus:@"status1"]] foreverblock:^(id firstData, NSDictionary<NSString *,id> *signalIdentifier2data) {
        testRegister_init_from_save = @"not null";
        return YES;
    }];
    XCTAssert(testRegister_init_from_save != nil);
